...
$DeploymentShareNTFS = "D:\MDTBuildLab"
icacls $DeploymentShareNTFS /grant '"LDNMDT004\MDT_BA":(OI)(CI)(RX)'
icacls $DeploymentShareNTFS /grant '"Administrators":(OI)(CI)(F)'
icacls $DeploymentShareNTFS /grant '"SYSTEM":(OI)(CI)(F)'
icacls "$DeploymentShareNTFS\Captures" /grant '"LDNMDT004\MDT_BA":(OI)(CI)(M)'
